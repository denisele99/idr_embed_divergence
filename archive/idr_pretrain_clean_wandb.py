...
# Initialize W&B
wandb.init(project="idr_lm_pretrain",
           name = 'idr-bert-low-lr1-30M-35ep')
...
data_file_path = '/home/moseslab/denise/IDR_LM/data/sequences/mobidb_idrs_27/mobi_idrs_30M.fasta'#'/home/moseslab/denise/IDR_LM/data/sequences/mobidb_idrs_27/mobi_idrs_60M.fasta'#'/home/moseslab/denise/IDR_LM/data/sequences/mobidb_ids_3M_filter_2.fasta'#'/home/moseslab/denise/IDR_LM/data/sequences/mobidb_idrs_27/mobi_idrs_30M.fasta'#'/home/moseslab/denise/IDR_LM/data/sequences/mobidb_idrs/mobi_idrs_2_0.fasta'#'/home/moseslab/denise/IDR_LM/data/sequences/IDP_BERT_pretrain_dataset.txt'##'/home/moseslab/denise/IDR_LM/data/mobidb_ids_3M_filter_2.fasta'#'/home/moseslab/denise/IDR_LM/data/IDP_BERT_pretrain_dataset.txt' # '/home/moseslab/denise/IDR_LM/data/mobidb_ids_3M_filter_2.fasta'#
dataset = load_fasta_as_dataset(data_file_path)

#TEMPORARY TODO
dataset = dataset.shuffle(seed=42)#.select(range(100000))#range(100000))
...
checkpoint_path = '/home/moseslab/denise/IDR_LM/results/model_checkpoints/30M_64b_5ep_-checkpoints-08-28/checkpoint-228180'#'/home/moseslab/denise/IDR_LM/results/model_checkpoints/30M_64b_5ep_-checkpoints-08-28/checkpoint-114105' #=5th epoch #'/home/moseslab/denise/IDR_LM/results/model_checkpoints/1M_8b_100ep-checkpoints/checkpoint-epoch-26'
...
training_args = TrainingArguments(
    ...
    output_dir='/home/moseslab/denise/IDR_LM/results',#/model_checkpoints',
    overwrite_output_dir=True,
    do_train = True,
    evaluation_strategy = 'epoch',
    num_train_epochs= 35,#args.num_train_epochs,
    learning_rate=args.learning_rate_1, #TODO Change back to learning_rate_1
    no_cuda=args.no_cuda,
    per_device_train_batch_size=batch_size,#args.train_batch_size,
...
#Save model
trainer.save_model("./saved_model/best_model_30M")
