...
# 模型保存目录
output_dir = '../results' #"../IDP_BERT/pretrained_model"
...
# 预构建词典
vocab_file = "/home/moseslab/denise/IDR_LM/IDP_BERT/DisoBert_vocab.txt"
do_lower_case = True
...
loss_scale = 0.
bert_config_json = "/home/moseslab/denise/IDR_LM/IDP_BERT/bert_config.json"
